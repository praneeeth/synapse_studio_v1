...
/// <summary>
/// EF Core repository for Core ASK aggregate entities.
/// </summary>
public sealed class CoreAskRepository : ICoreAskRepository
{
    ...
    public Task<Ask?> GetByIdAsync(int askId, CancellationToken cancellationToken = default)
    {
        return _dbContext.Asks
            .SingleOrDefaultAsync(x => x.AskId == askId, cancellationToken);
    }
